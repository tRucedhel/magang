...
function pindahHalaman() {
  ...
  const NIKPemilikRekening = document.querySelector('.c_perorangan-text12').innerText;
  ...
  window.location.href = `konfirmasi-setoran-NP?nama=${encodeURIComponent(namaPemilikRekening)}&nama_pendiri=${encodeURIComponent(namaPendiri)}&npwp_badan=${encodeURIComponent(NPWPBadan)}&jenis_rekening=${encodeURIComponent(jenisNomorRekening)}
