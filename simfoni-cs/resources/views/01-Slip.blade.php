...
<head>
    ...
    <title>SLIP</title>
    <link rel="stylesheet" href="frontend/styles/01-Slip.css">
...
<body>
                    ...
                    <div class="c_slip-frame11">
                            ...
                            <div class="input-frame">
                                <div class="input-text1">
                                    <div class="input-container input-text2">
                                        <input type="number" id="inputNIK" name="inputNIK" required placeholder=" "
                                            oninput="limitInputNIK()">
                        ...
                        <div class="input-instance">
                            <div class="input-frame">
                                <div class="input-text1">
                                    <div class="input-container input-text2">
                                        <input type="date" id="inputTanggalLahir" name="inputTanggalLahir" required
                                            placeholder=" ">
                    ...
                    <div class="c_slip-no-frame11">
                            ...
                            <div class="input-frame">
                                <div class="input-text1">
                                    <div class="input-container-NP input-text2">
                                        <input type="text" id="inputNPWP" name="inputNPWP" required maxlength="15" oninput="updateInput()" 
                                            placeholder=" ">
                        ...
                        <div class="input-instance">
                            <div class="input-frame">
                                <div class="input-text1">
                                    <div class="input-container-NP input-text2">
                                        <input type="number" id="inputNIKPendiri" name="inputNIKPendiri" required
                        ...
                        <div class="input-instance">
                            <div class="input-frame">
                                <div class="input-text1">
                                    <div class="input-container-NP input-text2">
                                        <input type="date" id="inputTanggalPendirian" name="inputTanggalPendirian"
                ...
                <div>
                    <div class="frame-button-popup">
                        <div class="frame-button-ya">
                            <button class="button-back-konfirmasi-ya" onclick="window.location.href='/'">
    ...
    <script src="/frontend/script/01-Slip.js"></script>
