            ...
            <div class="c_slip-frame06">
                <div class="c_slip-frame07">
                    <div class="c_slip-frame08">
                        ...
                        <input type="radio" name="slip" id="slip-setoran" class="radio-button" onclick="changeNextButtonUrl('slip-setoran-NP')"
                    ...
                    <div class="c_slip-frame09">
                        ...
                        <input type="radio" name="slip" id="slip-tarik" class="radio-button"
                            style="width: 30px; height: 30px;" />
                    </div>
                </div>
                <div class="c_slip-frame10">
                    ...
                    <div class="c_slip-frame12">
                        ...
                        <input type="radio" name="slip" id="slip-penutupan-tabungan" class="radio-button" onclick="changeNextButtonUrl('slip-penutupan-NP')"
                            style="width: 30px; height: 30px;"/>
                    </div>
                </div>
            </div>
