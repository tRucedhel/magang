...
<head>
    ...
    <link rel="stylesheet" href="frontend/styles/02-Slip-P.css">
...
<body>
            ...
            <div class="c_slip-frame06">
                <div class="c_slip-frame07">
                    <div class="c_slip-frame08">
                        ...
                        <input type="radio" name="slip" id="slip-setoran" class="radio-button" onclick="changeNextButtonUrl('slip-setoran-P')"
                    ...
                    <div class="c_slip-frame09">
                        ...
                        <input type="radio" name="slip" id="slip-tarik" class="radio-button" onclick=""
                            style="width: 30px; height: 30px;" />
                    </div>
                </div>
                <div class="c_slip-frame10">
                    ...
                    <div class="c_slip-frame12">
                        ...
                        <input type="radio" name="slip" id="slip-penutupan-tabungan" class="radio-button" onclick="changeNextButtonUrl('slip-penutupan-P')"
                            style="width: 30px; height: 30px;"/>
                    </div>
                </div>
            </div>
            <div class="c_slip-frame13">
                <button class="c_slip-instance6" id="lanjutkanButton">
                ...
                <div>
                    <div class="frame-button-popup">
                        <div class="frame-button-ya">
                            <button class="button-back-konfirmasi-ya" onclick="window.location.href='slip'">
    ...
    <script src="/frontend/script/02-Slip-P.js"></script>
