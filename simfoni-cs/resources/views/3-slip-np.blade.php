...
<head>
    ...
    <title>SLIP Non-Perorangan</title>
    <link rel="stylesheet" href="frontend/styles/3-slip-np.css">
...
<body>
    ...
    <div class="c_slip-frame03">
        ...
        <div class="c_slip-frame05">
                ...
                <div class="c_perorangan-frame07">
                    ...
                    <div class="input-instance">
                        <div class="input-frame">
                            <div class="input-text1">
                                <div class="input-container input-text2">
                                    <input type="text" id="inputJumlahSetoran" name="inputJumlahSetoran" required
                                        placeholder=" " class="wajib">
                ...
                <div class="c_perorangan-frame14">
                    <div class="c_perorangan-instance02">
                        <div class="c_perorangan-frame08">
                            ...
                            <div class="c_perorangan-text08">
                                <p class="c_perorangan-text09">01.234.567.8-123.000</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="c_perorangan-instance02">
                        <div class="c_perorangan-frame08">
                            ...
                            <div class="c_perorangan-text08">
                                <p class="c_perorangan-text09">32112312313102913</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="input-instance">
                        <div class="input-frame hide-on-checkbox-checked">
                            <div class="input-text1">
                                <div class="input-container input-text2">
                                    <input type="text" id="inputNIKPenyetor" name="inputNIKPenyetor" required
                                        placeholder=" ">
                    ...
                    <div class="input-instance">
                        <div class="input-frame hide-on-checkbox-checked">
                            <div class="input-text1">
                                <div class="input-container input-text2">
                                    <input type="text" id="inputNomorHPenyetor" name="inputNomorHPenyetor" required
                                        placeholder=" ">
            ...
            <div class="c_slip-frame13">
                <button class="c_slip-instance6" onclick="window.location.href='konfirmasi-np'">
                ...
                <div>
                    <div class="frame-button-popup">
                        <div class="frame-button-ya">
                            <button class="button-back-konfirmasi" onclick="window.location.href='slip2-np'">
    ...
    <script src="/frontend/script/3-slip-np.js"></script>
