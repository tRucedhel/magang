...
<head>
    ...
    <title>Konfirmasi Non-Perorangan</title>
    <link rel="stylesheet" href="frontend/styles/slip_penutupan/konfirmasi-penutupanT-NP.css">
...
<body>
        ...
        <div class="konfirmasi1-frame">
            ...
            <div class="konfirmasi1-content">
                <div class="konfirmasi1-frame01">
                    ...
                    <div class="konfirmasi1-form02">
                        <div class="konfirmasi1-frame03">
                            ...
                            <span class="konfirmasi1-text14">
                                <span id="outputNamaPendiri"></span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="konfirmasi1-form04" id="cekNorek" style="display: none;">
                    ...
                    <div class="konfirmasi1-form04" id="cekAlasanPT" style="display: none;">
                        <div class="konfirmasi1-frame05">
                            <span class="konfirmasi1-text20">
                                <span>Alasan Penutupan Rekening</span>
                            </span>
                            <span class="konfirmasi1-text22">
                                <span id="outputalasanPR1"></span>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="konfirmasi1-frame08">
                    <div class="konfirmasi1-form04" id="cekNorek1">
                        <div class="konfirmasi1-frame05">
                            <span class="konfirmasi1-text20">
                                <span>Jenis &amp; Nomor Rekening</span>
                            </span>
                            <span class="konfirmasi1-text22">
                                <span id="outputJenisRekening1"></span>
                            </span>
                        </div>
                    </div>

                    <div class="konfirmasi1-form04" id="cekAlasanPT1">
                        <div class="konfirmasi1-frame05">
                            <span class="konfirmasi1-text20">
                                <span>Alasan Penutupan Rekening</span>
                            </span>
                            <span class="konfirmasi1-text22">
                                <span id="outputalasanPR"></span>
                            </span>
                        </div>
                    </div>

                    <div class="konfirmasi1-form05" id="cekNamaPenutupTabungan" style="display: none;">
                        <div class="konfirmasi1-frame06">
                            <span class="konfirmasi1-text24">
                                <span>Nama Penutup Tabungan</span>
                            </span>
                            <span class="konfirmasi1-text26">
                                <span id="outputNamaPenutupTabungan"></span>
                            </span>
                        </div>
                    </div>
                    <div class="konfirmasi1-form06" id="cekNIKPenutupTabungan" style="display: none;">
                        <div class="konfirmasi1-frame07">
                            <span class="konfirmasi1-text28">
                                <span>NIK Penutup Tabungan</span>
                            </span>
                            <span class="konfirmasi1-text30">
                                <span id="outputNIKPenutupTabungan"></span>
                            </span>
                        </div>
                    </div>
                    <div class="konfirmasi1-form07" id="cekAlamatPenutupTabungan" style="display: none;">
                        <div class="konfirmasi1-frame10">
                            <span class="konfirmasi1-text34">
                                <span>Alamat Penutup Tabungan</span>
                            </span>
                            <span class="konfirmasi1-text36">
                                <span id="outputAlamatPenutupTabungan"></span>
                            </span>
                        </div>
                    </div>
                    <div class="konfirmasi1-form08" id="cekNoHPPenutupTabungan" style="display: none;">
                        <div class="konfirmasi1-frame11">
                            <span class="konfirmasi1-text38">
                                <span>Nomor HP Penutup Tabungan</span>
                            </span>
                            <span class="konfirmasi1-text40">
                                <span id="outputNomorHPPenutupTabungan"></span>
                            </span>
                        </div>
                    </div>
            ...
            <div class="c_slip-frame13">
                <button class="c_slip-instance6" onclick="window.location.href='struk-penutupan-NP'">
    ...
    <script src="frontend/script/slip_penutupan/konfirmasi-penutupanT-NP.js"></script>
