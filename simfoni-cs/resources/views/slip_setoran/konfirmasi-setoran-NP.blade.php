...
<head>
    ...
    <link rel="stylesheet" href="frontend/styles/slip_setoran/konfirmasi-setoran-NP.css">
...
<body>
    ...
    <div class="c_slip-frame03">
        ...
        <div class="konfirmasi1-frame">
            ...
            <div class="c_slip-frame13">
                <button class="c_slip-instance6" onclick="window.location.href='struk-setoran-NP'">
    ...
    <script src="frontend/script/slip_setoran/konfirmasi-setoran-NP.js"></script>
