...
<head>
  ...
  <title>Slip Seotran Perorangan</title>
  <link rel="stylesheet" href="frontend/styles/slip_setoran/slip-setoran-P.css">
...
<body>
        ...
        <div class="c_perorangan-frame07">
              ...
              <div class="input-text1">
                <div class="input-container input-text2">
                  <input type="text" id="inputTujuanTransaksi" name="inputTujuanTransaksi" required placeholder=" "
                    class="wajib" oninput="capitalizeFirstLetter(this)">
          ...
          <div class="input-instance">
            <div class="input-frame">
              <div class="input-text1">
                <div class="input-container input-text2">
                  <input type="text" id="inputJumlahSetoran" name="inputJumlahSetoran" oninput="updateInput()" required
  ...
  <script src="/frontend/script/slip_setoran/slip-setoran-P.js"></script>
